<%@ Page Language="C#" Debug="true" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="JQuery.login" %>
...
<body>
    <div class="container">      
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <div class="input-prepend">
                    ...
                    <asp:TextBox ID="Username" runat="server" class="span3" placeholder="usuario" value="" >admin</asp:TextBox>                 
                </div>
            </div>
        </div>
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <div class="input-prepend">
                    ...
                    <asp:TextBox ID="Password" runat="server" TextMode="Password" CssClass="span3" placeholder="contraseña">admin</asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <br /><br />
        <!-- mensajes -->
            <div id="logerror" runat="server"> </div>      
        </form>
    </div>   
